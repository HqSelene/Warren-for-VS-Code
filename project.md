...
- Marketing website: a responsive GitHub Pages landing page introduces Warren, demonstrates its four attention states, explains local-only data handling, and links to the published Windows release.
...
- A responsive Warren product website and GitHub Pages deployment workflow were added under `docs/`, with download links pinned to the published v0.0.1 Release page; the README now includes the Warren brand artwork and a current product screenshot.
